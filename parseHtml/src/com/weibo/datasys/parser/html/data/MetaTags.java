...
public class MetaTags
{
	...
	private Properties headTags = new Properties();
	...
	public String toString()
	{
		...
		sb.append("base=" + baseHref + ", noCache=" + noCache + ", noFollow=" + noFollow
				+ ", noIndex=" + noIndex + ", refresh=" + refresh + ", refreshHref=" + refreshHref
				+ "\n");
		...
		sb.append(" * headInfo tags:\n");
		it = headTags.keySet().iterator();
		while (it.hasNext())
		{
			String key = (String) it.next();
			sb.append("   - " + key + "\t=\t" + headTags.get(key) + "\n");
		}
		return sb.toString();
	}
