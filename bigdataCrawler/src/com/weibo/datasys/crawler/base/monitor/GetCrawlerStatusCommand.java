...
public class GetCrawlerStatusCommand implements ICommand {
	...
	public String excute(HttpExchange httpExchange) {
		...
		try {
			...
			builder.append("<strong>System Status: </strong>").append(
					"<br><br>");
			builder.append("<strong>System IP: </strong>")
					.append(Main.getSystemIP()).append("<br><br>");
			builder.append("<strong>System Name: </strong>")
					.append(Main.getSystemName()).append("<br><br>");
			builder.append("<strong>Run time: </strong>").append(runTime)
					.append("<br><br>");

			builder.append(CrawlerMonitorInfo.getReport().replaceAll("\\n",
					"<br>"));
